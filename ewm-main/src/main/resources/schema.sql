...
(
    ...
    EVENT_ID BIGINT not null,
    CONSTRAINT FK_USER_COMM FOREIGN KEY (creator_id) REFERENCES USERS (ID) ON DELETE CASCADE,
    CONSTRAINT FK_EVENT_COMM FOREIGN KEY (event_id) REFERENCES events (ID) ON DELETE CASCADE
    );